...
import (
	...
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_extension"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_health"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_image"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_launch_spec"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_load_balancer"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_login"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_network"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_persistence"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_scheduling"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_secret"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_strategy"
	"github.com/WitoldSlawko/terraform-provider-spotinst/azure_v3/stateful_node_azure_vm_sizes"
	"log"
	"time"
