...
import (
	...
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_aws"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_aws_compute"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_aws_compute_instance_type"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_aws_compute_launchspecification"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_aws_integrations"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_healthcheck"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_persistence"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_scheduling"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instance_strategy"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/commons/managed_instances_aws_compute_launchspecification_networkinterfaces"
)
