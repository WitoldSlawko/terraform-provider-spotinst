...
import (
	...
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_aws"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_aws_compute"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_aws_compute_instance_type"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_aws_compute_launchspecification"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_aws_integrations"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_healthcheck"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_persistence"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_scheduling"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instance_strategy"
	"https://github.com/WitoldSlawko/terraform-provider-spotinst/tree/main/spotinst/commons/managed_instances_aws_compute_launchspecification_networkinterfaces"
)
