...
import (
	...
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_block_devices"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_instance_types"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_integrations"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_launch_configuration"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_network_interface"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_scaling_policies"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_scheduled_task"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_stateful"
	"github.com/WitoldSlawko/terraform-provider-spotinst/elastigroup_aws_strategy"
)
