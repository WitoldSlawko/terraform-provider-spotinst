...
import (
	...
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_health_check"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_image"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_integrations"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_launch_configuration"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_load_balancer"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_login"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_network"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_scaling_policies"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_scheduled_task"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_strategy"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_azure_vm_sizes"
)
