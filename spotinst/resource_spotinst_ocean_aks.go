...
import (
	...
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_auto_scaling"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_extensions"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_health"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_image"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_launch_specification"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_load_balancers"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_login"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_network"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_os_disk"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_strategy"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/ocean_aks_vm_sizes"
)
