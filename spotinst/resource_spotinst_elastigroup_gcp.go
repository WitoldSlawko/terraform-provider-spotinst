...
import (
	...
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_disk"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_gpu"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_instance_types"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_integrations"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_launch_configuration"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_network_interface"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_scaling_policies"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_scheduled_task"
	"github.com/WitoldSlawko/terraform-provider-spotinst/spotinst/elastigroup_gcp_strategy"
)
